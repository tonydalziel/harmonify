...
<h4 class="h4 my-6 mx-3">
	Use the button below to generate some test data. This data contains 950 rows and 100 dimensions
	of what we call 'regular' data. This data is generated by sampling from the same distribution for
	each column. Additionally, 50 rows are generated completely randomly, we call this 'irregular'
