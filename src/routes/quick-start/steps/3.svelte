...
<h4 class="h5 m-3">Below are the seperate components of a harmonic signal with a fundamental frequency (the first wave's frequency) of 200 Hz. <b class="text-primary-500">Have a go clicking on each component to turn it on</b>. You will see the signal sounds most natural with all 5 components turned on!</h4>
